package com.wkdtech.search.service;

import com.fasterxml.jackson.core.type.TypeReference;
import com.wkdtech.common.enums.ExceptionEnum;
import com.wkdtech.common.exception.BizException;
import com.wkdtech.common.utils.JsonUtils;
import com.wkdtech.item.entity.*;
import com.wkdtech.search.client.BrandClient;
import com.wkdtech.search.client.CategoryClient;
import com.wkdtech.search.client.GoodsClient;
import com.wkdtech.search.client.SpecClient;
import com.wkdtech.search.dao.GoodsRepository;
...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        if (CollectionUtils.isEmpty(skuList)) {
            throw new BizException(ExceptionEnum.GOODS_NOT_FOUND);
        }
