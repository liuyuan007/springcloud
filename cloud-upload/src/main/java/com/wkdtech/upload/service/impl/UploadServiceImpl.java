package com.wkdtech.upload.service.impl;

import com.github.tobato.fastdfs.domain.StorePath;
import com.github.tobato.fastdfs.service.FastFileStorageClient;
import com.wkdtech.common.enums.ExceptionEnum;
import com.wkdtech.common.exception.BizException;
import com.wkdtech.upload.config.UploadProperties;
import com.wkdtech.upload.service.UploadService;
...
public class UploadServiceImpl implements UploadService {
    ...
    public String uploadImage(MultipartFile file) {
        ...
        if (!prop.getAllowTypes().contains(contentType)) {
            throw new BizException(ExceptionEnum.INVALID_FILE_FORMAT);
        }
        ...
        try {
            ...
            throw new BizException(ExceptionEnum.UPLOAD_IMAGE_EXCEPTION);
        }
