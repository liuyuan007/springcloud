package com.wkdtech.user.service;

import com.wkdtech.common.enums.ExceptionEnum;
import com.wkdtech.common.exception.BizException;
import com.wkdtech.common.utils.NumberUtils;
import com.wkdtech.user.entity.User;
import com.wkdtech.user.mapper.UserMapper;
import com.wkdtech.user.utils.CodecUtils;
...
public class UserService {
    ...
    public void register(User user, String code) {
        ...
        if (!StringUtils.equals(code, value)) {
            //验证码不匹配
            throw new BizException(ExceptionEnum.VERIFY_CODE_NOT_MATCHING);
        }*/
    ...
    public User queryUser(String username, String password) {
        ...
        if (!StringUtils.equals(CodecUtils.md5Hex(password, user.getSalt()), user.getPassword())) {
            //密码不正确
            throw new BizException(ExceptionEnum.PASSWORD_NOT_MATCHING);
        }
